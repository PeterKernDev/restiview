// test_general_screen.dart
// Redesign proof-of-concept version of general_screen.dart.
// Same fields and logic; uses rdLavender background and Faune font for styling experiments.
...
class TestGeneralScreen extends StatefulWidget {
  final ReviewContext context;

  const TestGeneralScreen({super.key, required this.context});

  @override
  State<TestGeneralScreen> createState() => _TestGeneralScreenState();
}

class _TestGeneralScreenState extends State<TestGeneralScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
      backgroundColor: AppColors.rdLavender,
      appBar: AppBar(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          TextFormField(
                            ...
                            style: const TextStyle(fontFamily: 'Faune'),
                            decoration: InputDecoration(
                              labelText: AppStr.restaurantLabel,
                              labelStyle: const TextStyle(fontFamily: 'Faune'),
                                      ...
                                      Expanded(
                                        child: TextField(
                                          ...
                                          decoration: const InputDecoration(
                                            ...
                                            hintStyle: TextStyle(fontFamily: 'Faune'),
                                          ),
                                        ),
                                      ),
                          ...
                          TextField(
                            ...
                            decoration: const InputDecoration(
                              ...
                              labelStyle: TextStyle(fontFamily: 'Faune'),
                            ),
                          ),
                          const SizedBox(height: 16),
                          Row(
